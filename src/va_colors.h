...
inline u32 PackBGRA(vec4 ColorV) {return ((u32)RoundF(ColorV.A*255.0f) << 24 | (u32)RoundF(ColorV.R*255.0f) << 16 | (u32)RoundF(ColorV.G*255.0f) << 8 | (u32)RoundF(ColorV.B*255.0f) << 0);}
